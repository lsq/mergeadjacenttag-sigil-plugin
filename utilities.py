...
url = "https://raw.githubusercontent.com/lsq/mergeadjacenttag-sigil-plugin/master/checkversion.xml"
delta = 12
...
def setupPrefs(prefs):
    ...
    if (
        "gui_selections" not in prefs
    ):  # If the json doesn't exist yet, assign wholesale defaults.
