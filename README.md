MergeAdjacentTag(A Sigil Plugin)
============

A Sigil plugin that helps users merge adjacent spans, divs and other elements based on their attributes (or lack thereof) in a nesting-safe manner.
...
First, clone the repo and cd into it:
    ...
    $ git clone https://github.com/lsq/mergeadjacenttag-sigil-plugin.git
    $ cd ./mergeadjacenttag-sigil-plugin
...
This will create the MergeAdjacentTag_vX.X.X.zip file that can then be installed into Sigil's plugin manager.
